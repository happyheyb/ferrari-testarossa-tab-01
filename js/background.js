var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-testarossa-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-testarossa-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-testarossa-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-testarossa-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari TestaRossa?",
				description: "Get awesome Ferrari TestaRossa HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
